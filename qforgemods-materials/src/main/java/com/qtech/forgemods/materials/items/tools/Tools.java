package com.qtech.forgemods.materials.items.tools;
...
import com.qtech.forgemods.materials.items.*;
...
public enum Tools {
    ...
    REDSTONE(builder("redstone")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":redstone")
                    .maxDamageFactor(8)
    ...
    COPPER(builder("copper")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":copper")
                    .maxDamageFactor(13)
    ...
    COMPRESSED_IRON(builder("compressed_iron")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":compressed_iron")
                    .maxDamageFactor(17)
    ...
    OBSIDIAN(builder("obsidian")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":obsidian")
                    .maxDamageFactor(17)
    ...
    SILVER(builder("silver")
            ...
            .armor(() -> TraitPack.create().allTools(ModTraits.HOLY.get()).build(), () -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":silver")
                    .maxDamageFactor(15)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(48)
                    ...
                    .build())
            .tools(() -> TraitPack.create().allTools(ModTraits.HOLY.get()).build(), () -> ItemTier.builder()
    ...
    LEAD(builder("lead")
            ...
            .armor(() -> TraitPack.create().allTools(ModTraits.POISON.get()).build(), () -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":lead")
                    .maxDamageFactor(14)
                    ...
                    .build())
            .tools(() -> TraitPack.create().allTools(ModTraits.POISON.get()).build(), () -> ItemTier.builder()
...
//            .armor(() -> ArmorMaterial.builder()
//                    .name(QFM: Materials.modId + ":tungsten")
//                    .maxDamageFactor(21)
...
//                    .repairMaterial(() -> Ingredient.fromItems(ModItems.TUNGSTEN_INGOT)).build())),
    NICKEL(builder("nickel")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":nickel")
                    .maxDamageFactor(13)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    PLATINUM(builder("platinum")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":platinum")
                    .maxDamageFactor(38)
                    .damageReduction(new int[]{3, 6, 8, 3})
                    .enchantability(14)
                    .knockbackResistance(0f)
    ...
    BISMUTH(builder("bismuth")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":bismuth")
                    .maxDamageFactor(14)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    ALUMINUM(builder("aluminum")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":aluminum")
                    .maxDamageFactor(13)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    URANIUM(builder("uranium")
            ...
            .armor(() -> TraitPack.create().allTools(ModTraits.RADIOACTIVE.get()).build(), () -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":uranium")
                    .maxDamageFactor(14)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
                    ...
                    .build())
            .tools(() -> TraitPack.create().allTools(ModTraits.WITHER.get()).build(), () -> ItemTier.builder()
    ...
    BRONZE(builder("bronze")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":bronze")
                    .maxDamageFactor(14)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(9)
                    .knockbackResistance(0f)
    ...
    ELECTRUM(builder("electrum")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":electrum")
                    .maxDamageFactor(14)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(11)
                    .knockbackResistance(0f)
    ...
    BISMUTH_BRASS(builder("bismuth_brass")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":bismuth_brass")
                    .maxDamageFactor(16)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    ALUMINUM_STEEL(builder("aluminum_steel")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":aluminum_steel")
                    .maxDamageFactor(17)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(9)
                    .knockbackResistance(0f)
    ...
    BISMUTH_STEEL(builder("bismuth_steel")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":bismuth_steel")
                    .maxDamageFactor(18)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    SIGNALUM(builder("signalum")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":signalum")
                    .maxDamageFactor(14)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    LUMIUM(builder("lumium")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":lumium")
                    .maxDamageFactor(12)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(36)
                    .knockbackResistance(0f)
    ...
    ENDERIUM(builder("enderium")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":enderium")
                    .maxDamageFactor(42)
                    ...
                    .build())
            .tools(() -> TraitPack.create().allTools(ModTraits.ENDER.get()).build(), () -> ItemTier.builder()
    ...
    COBALT(builder("cobalt")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":cobalt")
                    .maxDamageFactor(64)
    ...
    ULTRINIUM(builder("ultrinium")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":ultrinium")
                    .maxDamageFactor(192)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(224)
                    .knockbackResistance(1f)
    ...
    INFINITY(builder("infinity")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMMaterials.modId + ":infinity")
...
//    ;
    ...
    private static class Builder {
        ...
        Builder armor(Supplier<TraitPack> pack, Supplier<IArmorMaterial> armorMaterial) {
            ...
            this.helmet = () -> new ArmorTool(armorMaterial.get(), EquipmentSlotType.HEAD, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().helmet);
            this.chestplate = () -> new ArmorTool(armorMaterial.get(), EquipmentSlotType.CHEST, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().chestplate);
            this.leggings = () -> new ArmorTool(armorMaterial.get(), EquipmentSlotType.LEGS, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().leggings);
            this.boots = () -> new ArmorTool(armorMaterial.get(), EquipmentSlotType.FEET, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().boots);
            return this;
        }
        ...
        Builder tools(Supplier<TraitPack> pack, Supplier<IItemTier> itemTier) {
            ...
            this.sword = () -> new SwordTool(itemTier.get(), 3, -2.4f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().sword) {};
            this.axe = () -> new AxeTool(itemTier.get(), 5.0f, -3.0f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().axe) {};
            this.pickaxe = () -> new PickaxeTool(itemTier.get(), 1, -2.8f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().pickaxe);
            this.shovel = () -> new ShovelTool(itemTier.get(), 1.5f, -3.0f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().shovel);
            this.hoe = () -> new HoeTool(itemTier.get(), (int) -(itemTier.get().getAttackDamage() - 1), -1.0f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().hoe);
            this.longsword = () -> new LongswordTool(itemTier.get(), 3, -3.0f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().longsword);
            this.broadsword = () -> new BroadswordTool(itemTier.get(), 4, -2.5f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().broadsword);
            this.katana = () -> new KatanaTool(itemTier.get(), 3, -1.0f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().katana);
            this.lumberAxe = () -> new LumberAxeTool(itemTier.get(), 5.5f, -2.8f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().lumberAxe);
            this.battleaxe = () -> new BattleaxeTool(itemTier.get(), 6.5f, -2.7f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().battleaxe);
            this.hammer = () -> new HammerTool(itemTier.get(), 4, -2.7f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().hammer);
            this.excavator = () -> new ExcavatorTool(itemTier.get(), 2.0f, -2.8f, new Item.Properties().group(MaterialsItemGroups.TOOLS), () -> pack.get().excavator);
            return this;
        }
