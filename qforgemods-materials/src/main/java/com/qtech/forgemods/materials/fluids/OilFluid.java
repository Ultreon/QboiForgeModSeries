package com.qtech.forgemods.materials.fluids;

import com.qtech.forgemods.materials.MaterialsBlocks;
import com.qtech.forgemods.materials.MaterialsFluids;
...
public abstract class OilFluid extends FlowingFluid {
   ...
   public Fluid getFlowingFluid() {
      return MaterialsFluids.FLOWING_OIL;
   }

   @Override
   public Fluid getStillFluid() {
      return MaterialsFluids.OIL;
   }

   @Override
   public Item getFilledBucket() {
      return MaterialsItems.OIL_BUCKET.get();
   }
   ...
   protected FluidAttributes createAttributes() {
      return FluidAttributes.builder(
              new ResourceLocation("qfm_materials:blocks/oil_still"),
              new ResourceLocation("qfm_materials:blocks/oil_flowing"))
              .translationKey("block.qfm_materials.oil")
...
//      return ParticleTypes.DRIPPING_LAVA;
   ...
   public BlockState getBlockState(FluidState state) {
      return MaterialsBlocks.OIL.get().getDefaultState().with(FlowingFluidBlock.LEVEL, getLevelFromState(state));
   }

   @Override
   public boolean isEquivalentTo(Fluid fluidIn) {
      return fluidIn == MaterialsFluids.OIL || fluidIn == MaterialsFluids.FLOWING_OIL;
   }
