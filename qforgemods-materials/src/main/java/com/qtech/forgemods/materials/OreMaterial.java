...
//    ;
    ...
    public static void registerBlocks() {
        for (OreMaterial metal : values()) {
            if (metal.oreSupplier != null) {
                ...
                metal.ore = new BlockRegistryObject<>(MaterialsRegistration.BLOCKS.register(name, metal.oreSupplier));
                MaterialsRegistration.ITEMS.register(name, () ->
                        new BlockItem(metal.ore.get(), new Item.Properties().group(MaterialsItemGroups.ORES)));
            }
        }
        for (OreMaterial metal : values()) {
            if (metal.storageBlockSupplier != null) {
                String name = metal.getName() + "_block";
                metal.storageBlock = new BlockRegistryObject<>(MaterialsRegistration.BLOCKS.register(name, metal.storageBlockSupplier));
                MaterialsRegistration.ITEMS.register(name, () ->
                        new BlockItem(metal.storageBlock.get(), new Item.Properties().group(MaterialsItemGroups.ORES)));
            }
        }
    }
    ...
    private static class Builder {
        ...
        Builder chunks() {
            this.chunks = () -> new Item(new Item.Properties().group(MaterialsItemGroups.METAL_CRAFTABLES));
            this.chunksTag = itemTag(QFMMaterials.rl("chunks/" + name));
            return this;
        }

        Builder dust() {
            this.dust = () -> new Item(new Item.Properties().group(MaterialsItemGroups.METAL_CRAFTABLES));
            this.dustTag = itemTag("dusts/" + name);
            return this;
        }

        Builder ingot() {
            this.ingot = () -> new Item(new Item.Properties().group(MaterialsItemGroups.METAL_CRAFTABLES));
        ...
        Builder nugget() {
            this.nugget = () -> new Item(new Item.Properties().group(MaterialsItemGroups.METAL_CRAFTABLES));
        ...
        Builder gem() {
            this.gem = () -> new Item(new Item.Properties().group(MaterialsItemGroups.GEMS));
