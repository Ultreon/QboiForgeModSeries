...
import com.qtech.forgemods.materials.items.tools.trait.*;
...
public final class ModTraits {
    ...
    public static final DeferredRegister<AbstractTrait> REGISTRY = DeferredRegister.create(AbstractTrait.class, QFMMaterials.modId);
