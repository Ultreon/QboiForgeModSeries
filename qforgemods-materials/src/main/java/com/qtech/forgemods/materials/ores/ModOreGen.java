package com.qtech.forgemods.materials.ores;
...
public final class ModOreGen {
    ...
    public void addOresFeatures() {
        ...
        QFMMaterials.LOGGER.info("-===========- Create Ore Features [START] -===========-");

        addOreFeature((a) -> a.count(12).range(30, 48), 6,
                new BlockMatchRuleTest(Blocks.DIRT), MaterialsBlocks.GILDED_DIRT.get(),
...
//        );
        ...
        QFMMaterials.LOGGER.info("-===========- Create Ore Features [ END ] -===========-");
    }
...
//        }
        ...
        if (i > 0) {
            if (i == 1) {
                QFMMaterials.LOGGER.info("Added " + i + " ore to biome: " + event.getName());
            } else {
                QFMMaterials.LOGGER.info("Added " + i + " ores to biome: " + event.getName());
            }
        }
    }
}
