...
public class ModRecipesProvider extends RecipeProvider {
    ...
    private static void registerAlloySmelting(Consumer<IFinishedRecipe> consumer) {
        // Todo: Move material alloy smelting recipe providers for OreMaterial to 'com.qtech.forgemods:materials'
...
//                .build(consumer);
    ...
    private static void registerCompressingRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        // Todo: Move material compressing recipe providers for OreMaterial to 'com.qtech.forgemods:materials'
...
//                .build(consumer);
    ...
    private static void registerCrushingRecipes(Consumer<IFinishedRecipe> consumer) {
        // Todo: Move ore crushing recipe providers for OreMaterial to 'com.qtech.forgemods:materials'
...
//                .build(consumer);
    ...
    private void registerMetalCrafting(Consumer<IFinishedRecipe> consumer) {
        // Todo: Move ore material recipe providers to 'com.qtech.forgemods:materials'
//        for (OreMaterial metal : OreMaterial.values()) {
...
//        }
    ...
    @SuppressWarnings({"OptionalGetWithoutIsPresent", "CommentedOutCode"})
    private void registerBlockCrafting(Consumer<IFinishedRecipe> consumer) {
        ...
        ExtendedShapedRecipeBuilder.vanillaBuilder(ModBlocks.SPRUCE_DRYING_RACK)
                ...
                .build(consumer);
        // Todo: move eucalyptus & cherry drying rack recipe providers to 'com.qtech.forgemods:materials'
...
//                .build(consumer);
    ...
    private void registerSmelting(Consumer<IFinishedRecipe> consumer) {
        // Todo: Move smelting recipe providers for ore materials to 'com.qtech.forgemods:mateials'
//        for (OreMaterial metal : OreMaterial.values()) {
