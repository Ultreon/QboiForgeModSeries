...
import com.qtech.forgemods.tools.items.tools.trait.*;
...
public final class ModTraits {
    ...
    public static final DeferredRegister<AbstractTrait> REGISTRY = DeferredRegister.create(AbstractTrait.class, QFMTools.modId);
