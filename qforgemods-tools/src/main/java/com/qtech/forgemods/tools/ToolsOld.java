...
//                return resistance * (resistance ^ pi) / resistance * 5
        ...
        // Registry.
        this.registry = ToolsRegistration.ITEMS;
    }

    public static void register() {
        for (ToolsOld toolsOld : ToolsOld.values()) {
            // Armor pieces
            toolsOld.helmetProvider = toolsOld.registry.register(toolsOld.name() + "_helmet", () -> new ArmorItem(toolsOld.armorMaterial, EquipmentSlotType.HEAD, new Item.Properties().group(QFMTools.ITEM_GROUP)) {
                @Override
                public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
                    toolsOld.doArmorTick(stack, world, player);
                }
            });
            toolsOld.chestplateProvider = toolsOld.registry.register(toolsOld.name() + "_chestplate", () -> new ArmorItem(toolsOld.armorMaterial, EquipmentSlotType.CHEST, new Item.Properties().group(QFMTools.ITEM_GROUP)) {
                @Override
                public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
                    toolsOld.doArmorTick(stack, world, player);
                }
            });
            toolsOld.leggingsProvider = toolsOld.registry.register(toolsOld.name() + "_leggings", () -> new ArmorItem(toolsOld.armorMaterial, EquipmentSlotType.LEGS, new Item.Properties().group(QFMTools.ITEM_GROUP)) {
                @Override
                public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
                    toolsOld.doArmorTick(stack, world, player);
                }
            });
            toolsOld.bootsProvider = toolsOld.registry.register(toolsOld.name() + "_boots", () -> new ArmorItem(toolsOld.armorMaterial, EquipmentSlotType.FEET, new Item.Properties().group(QFMTools.ITEM_GROUP)) {
                @Override
                public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
                    toolsOld.doArmorTick(stack, world, player);
                }
            ...
            // Tools.
            toolsOld.swordProvider = toolsOld.registry.register(toolsOld.name() + "_sword", () -> new SwordItem(toolsOld.itemTier, 3, -2.4f, new Item.Properties().group(QFMTools.ITEM_GROUP)) {
                @Override
                public ActionResultType onItemUse(ItemUseContext context) {
            ...
            toolsOld.axeProvider = toolsOld.registry.register(toolsOld.name() + "_axe", () -> new AxeItem(toolsOld.itemTier, 5.0f, -3.0f, new Item.Properties().group(QFMTools.ITEM_GROUP)) {
                @Override
                public ActionResultType onItemUse(ItemUseContext context) {
                    return toolsOld.onItemUse(context);
                }
            ...
            toolsOld.pickaxeProvider = toolsOld.registry.register(toolsOld.name() + "_pickaxe", () -> new PickaxeItem(toolsOld.itemTier, 1, -2.8f, new Item.Properties().group(QFMTools.ITEM_GROUP)) {
                @Override
                public ActionResultType onItemUse(ItemUseContext context) {
                    return toolsOld.onItemUse(context);
                }
            ...
            toolsOld.shovelProvider = toolsOld.registry.register(toolsOld.name() + "_shovel", () -> new ShovelItem(toolsOld.itemTier, 1.5f, -3.0f, new Item.Properties().group(QFMTools.ITEM_GROUP)) {
                @Override
                public ActionResultType onItemUse(ItemUseContext context) {
                    return toolsOld.onItemUse(context);
                }
            ...
            toolsOld.hoeProvider = toolsOld.registry.register(toolsOld.name() + "_hoe", () -> new HoeItem(toolsOld.itemTier, -3, -0.0f, new Item.Properties().group(QFMTools.ITEM_GROUP)) {
                @Override
                public ActionResultType onItemUse(ItemUseContext context) {
                    return toolsOld.onItemUse(context);
                }
    ...
    public String getTranslationKey() {
        return "tool_material." + QFMTools.modId + "." + getStringName();
    }
}
