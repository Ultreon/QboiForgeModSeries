...
import com.qtech.forgemods.tools.ToolsRegistration;
import com.qtech.forgemods.tools.items.*;
...
public enum Tools {
    ...
    COMPRESSED_IRON(builder("compressed_iron")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMTools.modId + ":compressed_iron")
                    .maxDamageFactor(17)
...
//                    .repairMaterial(() -> Ingredient.fromItems(ModItems.TUNGSTEN_INGOT)).build())),
    ...
    BISMUTH_BRASS(builder("bismuth_brass")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMTools.modId + ":bismuth_brass")
                    .maxDamageFactor(16)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    ALUMINUM_STEEL(builder("aluminum_steel")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMTools.modId + ":aluminum_steel")
                    .maxDamageFactor(17)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(9)
                    .knockbackResistance(0f)
    ...
    BISMUTH_STEEL(builder("bismuth_steel")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QFMTools.modId + ":bismuth_steel")
                    .maxDamageFactor(18)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
...
//    ;
    ...
    private static class Builder {
        ...
        Builder armor(Supplier<TraitPack> pack, Supplier<IArmorMaterial> armorMaterial) {
            ...
            this.helmet = () -> new ArmorTool(armorMaterial.get(), EquipmentSlotType.HEAD, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().helmet);
            this.chestplate = () -> new ArmorTool(armorMaterial.get(), EquipmentSlotType.CHEST, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().chestplate);
            this.leggings = () -> new ArmorTool(armorMaterial.get(), EquipmentSlotType.LEGS, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().leggings);
            this.boots = () -> new ArmorTool(armorMaterial.get(), EquipmentSlotType.FEET, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().boots);
            return this;
        }
        ...
        Builder tools(Supplier<TraitPack> pack, Supplier<IItemTier> itemTier) {
            ...
            this.sword = () -> new SwordTool(itemTier.get(), 3, -2.4f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().sword) {};
            this.axe = () -> new AxeTool(itemTier.get(), 5.0f, -3.0f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().axe) {};
            this.pickaxe = () -> new PickaxeTool(itemTier.get(), 1, -2.8f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().pickaxe);
            this.shovel = () -> new ShovelTool(itemTier.get(), 1.5f, -3.0f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().shovel);
            this.hoe = () -> new HoeTool(itemTier.get(), (int) -(itemTier.get().getAttackDamage() - 1), -1.0f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().hoe);
            this.longsword = () -> new LongswordTool(itemTier.get(), 3, -3.0f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().longsword);
            this.broadsword = () -> new BroadswordTool(itemTier.get(), 4, -2.5f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().broadsword);
            this.katana = () -> new KatanaTool(itemTier.get(), 3, -1.0f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().katana);
            this.lumberAxe = () -> new LumberAxeTool(itemTier.get(), 5.5f, -2.8f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().lumberAxe);
            this.battleaxe = () -> new BattleaxeTool(itemTier.get(), 6.5f, -2.7f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().battleaxe);
            this.hammer = () -> new HammerTool(itemTier.get(), 4, -2.7f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().hammer);
            this.excavator = () -> new ExcavatorTool(itemTier.get(), 2.0f, -2.8f, new Item.Properties().group(QFMTools.ITEM_GROUP), () -> pack.get().excavator);
            return this;
        }
